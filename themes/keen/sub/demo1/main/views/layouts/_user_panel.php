...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            HTML, ['user/my-account'], ['class' => 'navi-item']) ?>
            ...
            HTML, ['user/my-password'], ['class' => 'navi-item']) ?>
            ...
            HTML, ['setting/my-setting'], ['class' => 'navi-item']) ?>
            ...
            HTML, ['role/my-role'], ['class' => 'navi-item']) ?>
        ...
        <!--begin::Notifications-->
        <?php # $this->render('_recent_notification') ?>
        <!--end::Notifications-->
