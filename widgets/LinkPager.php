...
class LinkPager extends Widget
{
     ...
     */
    public $options = ['class' => 'd-flex flex-wrap py-2'];
    /**
     ...
     */
    public $prevPageCssClass = 'btn btn-icon btn-sm border-0 btn-light mr-2 my-1';
    /**
     * @var string the CSS class for the "next" page button.
     */
    public $nextPageCssClass = 'btn btn-icon btn-sm border-0 btn-light mr-2 my-1';
    /**
     * @var string the CSS class for the active (currently selected) page button.
     */
    public $activePageCssClass = 'btn-hover-primary active';
    /**
     ...
     */
    public $nextPageLabel = '<i class="ki ki-bold-arrow-next icon-xs"></i>';
    /**
     * @var string|bool the text label for the "previous" page button. Note that this will NOT be HTML-encoded.
     * If this property is false, the "previous" page button will not be displayed.
     */
    public $prevPageLabel = '<i class="ki ki-bold-arrow-back icon-xs"></i>';
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        $tag = ArrayHelper::remove($options, 'tag', $this->mainTag);
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        $linkWrapTag = ArrayHelper::remove($options, 'tag', 'a');
